...
public class LeviathansAxeModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LEVIATHANS_AXE_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TutorialMod.MOD_ID, "leviathans_axe"), "main");

...
public class CustomItemRenderer extends ItemRenderer {
    ...
    public static final ModelResourceLocation TIDE_BREAKER_MODEL = new ModelResourceLocation(TutorialMod.MOD_ID,"models/item/", "tide_breaker");
    public static final ModelResourceLocation TIDE_BREAKER_IN_HAND_MODEL = new ModelResourceLocation(TutorialMod.MOD_ID,"models/item/", "tide_breaker_in_hand");
    public CustomItemRenderer(Minecraft pMinecraft, TextureManager pTextureManager, ModelManager pModelManager, ItemColors pItemColors, BlockEntityWithoutLevelRenderer pBlockEntityRenderer, ItemModelShaper itemModelShaper) {
    ...
    public void render(ItemStack pItemStack, ItemDisplayContext pDisplayContext, boolean pLeftHand, PoseStack pPoseStack, MultiBufferSource pBuffer, int pCombinedLight, int pCombinedOverlay, BakedModel pModel) {
        if (!pItemStack.isEmpty()) {
            ...
            if (flag) {
                ...
                } else if (pItemStack.is(ModItems.TIDE_BREAKER.get())) {
                    pModel = this.itemModelShaper.getModelManager().getModel(TIDE_BREAKER_MODEL);
                }
            }

...
public class NetherBlade extends CustomSwordItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        String meleeDamageTranslation = "sword_lore.green_text_arrow.melee.0";
        ...
        if (sharpnessLevel > 0) {
            meleeDamageTranslation = "sword_lore.green_text_arrow.melee."+ swordSharpnessMeleeDamage;
            sword_stats_arrow_five = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation
                    (meleeDamageTranslation))).withStyle(GREEN_TEXT);
        }
        if (smiteLevel > 0) {
            meleeDamageTranslation = "sword_lore.green_text_arrow.melee."+ swordSmiteMeleeDamage;
            sword_stats_arrow_five = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation
                    (meleeDamageTranslation))).withStyle(GREEN_TEXT);
        }
        if (arthropodLevel > 0) {
            meleeDamageTranslation = "sword_lore.green_text_arrow.melee."+ swordArthropodMeleeDamage;
            sword_stats_arrow_five = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation
                    (meleeDamageTranslation))).withStyle(GREEN_TEXT);
        }

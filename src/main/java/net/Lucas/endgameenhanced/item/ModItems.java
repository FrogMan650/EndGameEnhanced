...
//gems
    ...
    public static final RegistryObject<Item> TOTEM_OF_NOURISHING = ITEMS.register("totem_of_nourishing", () -> new NourishingTotem(new Item.Properties().rarity(Rarity.UNCOMMON).durability(50)));

...
public class ModToolTiers {
    public static final Tier SAPPHIRE = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EndGameEnhanced.MOD_ID, "sapphire"), List.of(Tiers.NETHERITE), List.of());
    public static final Tier JADE = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EndGameEnhanced.MOD_ID, "jade"), List.of(Tiers.NETHERITE), List.of());
    public static final Tier OPAL = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EndGameEnhanced.MOD_ID, "opal"), List.of(Tiers.NETHERITE), List.of());
    public static final Tier EMERALD = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EndGameEnhanced.MOD_ID, "emerald"), List.of(Tiers.NETHERITE), List.of());
    public static final Tier RUBY = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EndGameEnhanced.MOD_ID, "ruby"), List.of(Tiers.NETHERITE), List.of());
    public static final Tier ONYX = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(EndGameEnhanced.MOD_ID, "onyx"), List.of(Tiers.NETHERITE), List.of());

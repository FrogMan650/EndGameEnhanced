...
public class CustomSmithingTemplateItem extends SmithingTemplateItem {
    ...
    private static final Component INEVITABLE_ARMOR_UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation("endgameenhanced:pure_tough_essence"))).withStyle(DESCRIPTION_FORMAT);

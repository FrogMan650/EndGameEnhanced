...
public class LargeFlaskItem extends BottleItem {
    public LargeFlaskItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public ItemStack assemblePotion(ItemStack potionStack) {
        ItemStack newFlaskStack = new ItemStack(ModItems.LARGE_FLASK_POTION.get());

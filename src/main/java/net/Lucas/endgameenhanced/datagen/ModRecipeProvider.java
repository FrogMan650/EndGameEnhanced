...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.TOTEM_OF_UNDYING, 1)
                ...
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.CHARGING_TOTEM.get(), 1)
                ...
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.FAST_CHARGING_TOTEM.get(), 1)
                .requires(ModItems.CHARGING_TOTEM.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.PURE_NOURISHING_ESSENCE.get())
                ...
                .unlockedBy(getHasName(ModItems.TIER_TWO_HUNGER_TOTEM.get()), has(ModItems.TIER_TWO_HUNGER_TOTEM.get()))
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.TOTEM_OF_NOURISHING.get(), 1)
                ...
                .unlockedBy(getHasName(ModItems.UNATTUNED_TOTEM.get()), has(ModItems.UNATTUNED_TOTEM.get()))
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.TIER_FIVE_HUNGER_TOTEM.get(), 1)
                ...
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.TIER_FOUR_HUNGER_TOTEM.get(), 1)
                .requires(ModItems.TIER_FIVE_HUNGER_TOTEM.get())
                .requires(ModItems.MAINTAINING_ESSENCE.get())
                .unlockedBy(getHasName(ModItems.TIER_FIVE_HUNGER_TOTEM.get()), has(ModItems.TIER_FIVE_HUNGER_TOTEM.get()))
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.TIER_THREE_HUNGER_TOTEM.get(), 1)
                .requires(ModItems.TIER_FOUR_HUNGER_TOTEM.get())
                .requires(ModItems.NURTURING_ESSENCE.get())
                .unlockedBy(getHasName(ModItems.TIER_FOUR_HUNGER_TOTEM.get()), has(ModItems.TIER_FOUR_HUNGER_TOTEM.get()))
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.TIER_TWO_HUNGER_TOTEM.get(), 1)
                .requires(ModItems.TIER_THREE_HUNGER_TOTEM.get())
                .requires(ModItems.PROVIDING_ESSENCE.get())
                .unlockedBy(getHasName(ModItems.TIER_THREE_HUNGER_TOTEM.get()), has(ModItems.TIER_THREE_HUNGER_TOTEM.get()))
                .save(pRecipeOutput);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.TIER_ONE_HUNGER_TOTEM.get(), 1)
                .requires(ModItems.TIER_TWO_HUNGER_TOTEM.get())

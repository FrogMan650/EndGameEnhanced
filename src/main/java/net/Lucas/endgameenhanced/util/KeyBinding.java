...
public class KeyBinding {
    public static final String KEY_CATEGORY_TUTORIAL = "key.category.endgameenhanced.tutorial";
    public static final String KEY_CHANGE_TOOL_EFFECT = "key.endgameenhanced.change_tool_effect";
